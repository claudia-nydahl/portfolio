			...
			<section class="col-dk-12 project-section main-section">
				<section class="col-dk-12 portfolio-item">
					<div class="project-info">
						<h1>Woolworths UI</h1>
						<p>This Woolworths UI is a re-design of the company's old website. It focuses on improving the site's user interface and user experience. The functionality of the site and how the user would interact is key. Note: this is just a UI and an actual website was not built.</p>
					</div>
				...
				<section class="col-dk-12 portfolio-item-images">
					<img src="img/ww-ui-2.png">
					<img src="img/ww-ui-3.png">
					<div class="half-images">
						<img src="img/ww-ui-tablet.png">
						<img src="img/ww-ui-mobi.png">
					</div>
