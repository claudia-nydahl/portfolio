			...
			<section class="col-dk-12 project-section main-section">
				<section class="col-dk-12 portfolio-item">
					<div class="project-info">
						<h1>Yuschav Arly</h1>
						<p>This is a portfolio website for an international artist, Yuschav Arly. It displays his best illustration work and provides information about the artist. A custom theme was created for this website using PHP and Wordpress. All aspects of the website is dynamic, so that branding, imagery or copy can be changed.</p>
						<br>
						<p><i>Link to website currently not available</i></p>
					</div>
				...
				<section class="col-dk-12 portfolio-item-images">
					<img src="img/yuschav-arly-1.png">
					<div class="half-images">
						<img src="img/yuschav-arly-2.png">
						<img src="img/yuschav-arly-3.png">
					</div>
					<img src="img/yuschav-arly-4.png">
				</section>

				<section class="col-dk-12 portfolio-buttons">
					<div>
						<!-- <a class="button" href="http://claudianydahl.friendsof.design/" target="_blank">Link to website</a> -->
